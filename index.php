<?php
// ১. ডাটাবেজ কানেকশন এবং এরর হ্যান্ডলিং
...
// ডাটাবেজ কানেকশন না হলে সুন্দর মেসেজ দেখাবে
if (!$conn) { 
    echo "<div style='text-align:center; padding:50px; font-family:sans-serif;'><h2>Database Connection Failed!</h2><p>অনুগ্রহ করে আপনার ক্রেডেনশিয়াল বা নেটওয়ার্ক চেক করুন।</p></div>";
    exit;
}

// ২. ডাটাবেজ থেকে ডাটা নিয়ে আসা
...
if ($result) {
    while ($row = pg_fetch_assoc($result)) {
        // ক্যাটাগরি ফাকা থাকলে ডিফল্ট নাম দেওয়া
...
<head>
    ...
    <title>ID Card Scanner & E-Service Web Hub</title>
